...
export class RecipePlaceSearchComponent implements OnInit {
  ...
  getVenues() {
    ...
    if (this.placeValue != null && this.placeValue !== '' && this.recipeValue != null && this.recipeValue !== '') {
      this._http.get('https://api.foursquare.com/v2/venues/search?client_id=ZRALWUNR2QVCCC3R1DBQFG3BAMPTOFPTUJNJ0WOHZGRFKJ0E' +
        '&client_secret=PW3VOLZRHUGKCI0ZGWH00HUTY02XE4KPJTVTZMDTHZTAP4KT&v=20180323&limit=10&near=' + this.placeValue + '&query=' + this.recipeValue).subscribe((restaurants: any) => {
